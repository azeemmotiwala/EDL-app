...
Future<bool> checkUsername(String username) async {
  final response = await http.get(Uri.parse('http://192.168.0.120:8000/check-username/${username}'));
...
Future<bool> checkPassword(String password) async {
  final response = await http.get(Uri.parse('http://192.168.0.120:8000/check-password/${password}'));
    ...
    return Column(
      ...
      children: [
        ...
        ElevatedButton(
          ...
          bool isUsernameValid = await checkUsername(usernameController.text);
